...
class TestAccountModel(TestCase):
    ...
    def test_create_an_account(self):
        ...
        self.assertEqual(str(account), "<Account Kevin id=[None]>")
        self.assertTrue(account is not None)
        self.assertEqual(account.id, None)
        self.assertEqual(account.name, "Kevin")
        self.assertEqual(account.email, "kevin@example.com")
        self.assertEqual(account.address, "123 Main St")
    ...
    def test_update_account(self):
        ...
        accounts = Account.all()
        self.assertEqual(len(accounts), 1)
        self.assertEqual(accounts[0].email, "XYZZY@plugh.com")
    ...
    def test_serialize_an_account(self):
        ...
        self.assertEqual(serial_account["active"], account.active)
